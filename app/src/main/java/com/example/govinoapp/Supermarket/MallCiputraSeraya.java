...
public class MallCiputraSeraya extends ListActivity {
    ...
    private void tampilkanPilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortel = "tel:0761-868888";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));
            } else if (pilihan.equals("SMS Center")){
                String smsText = "Elvino Dwi Saputra / L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:0761868888"));
                a.putExtra("sms_body",smsText);
            } else if (pilihan.equals("Driving Direction")){
                String lokasiRS = "google.navigation:q=0.5368139386686538, 101.4307412479321";
                ...
                a.putExtra(SearchManager.QUERY, "Mall Ciputra Seraya");
