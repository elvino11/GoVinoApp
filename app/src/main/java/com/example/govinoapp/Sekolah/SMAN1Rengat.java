package com.example.govinoapp.Sekolah;
...
public class SMAN1Rengat extends ListActivity {
    ...
    private void tampilkanPilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortel = "tel:0769-21617";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));
            } else if (pilihan.equals("SMS Center")){
                String smsText = "Elvino Dwi Saputra / L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:076921617"));
                a.putExtra("sms_body",smsText);
            } else if (pilihan.equals("Driving Direction")){
                String lokasiRS = "google.navigation:q=-0.3705919701825057, 102.52358554663373";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiRS));
            } else if (pilihan.equals("Website")) {
                String website = "https://sman1rengat.sch.id/html/index.php";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));
            } else if (pilihan.equals("Info Google")){
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "SMA Negeri 1 Rengat");
